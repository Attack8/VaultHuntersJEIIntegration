...
public class ForgeJewelRecipeCategory implements IRecipeCategory<JewelForgeRecipe> {
    public static final RecipeType<JewelForgeRecipe> RECIPE_TYPE = RecipeType.create("the_vault", "jewel_forge", JewelForgeRecipe.class);
    private static final ResourceLocation TEXTURE = TheVaultJEI.rl("textures/gui/forge_table_base.png");
    private final IDrawable background;
    private final IDrawable icon;

    public ForgeJewelRecipeCategory(final IGuiHelper guiHelper) {
        this.background = guiHelper.createDrawable(TEXTURE, 46, 15, 100, 55);
        this.icon = guiHelper.createDrawableIngredient(VanillaTypes.ITEM_STACK, new ItemStack(ModItems.JEWEL));
    }

    @Nonnull
    public Component getTitle() {
        return ModItems.JEWEL.getName(new ItemStack(ModItems.JEWEL));
    }
    ...
    public void setRecipe(IRecipeLayoutBuilder builder, JewelForgeRecipe recipe, IFocusGroup focuses) {
    ...
    @Nonnull
    public RecipeType<JewelForgeRecipe> getRecipeType() {
        return RECIPE_TYPE;
    }
    ...
    @Nonnull
    public Class<? extends JewelForgeRecipe> getRecipeClass() {
